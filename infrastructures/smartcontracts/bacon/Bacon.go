...
func (_Bacon *BaconFilterer) FilterBaconBurned(opts *bind.FilterOpts, tokenId []*big.Int) (*BaconBaconBurnedIterator, error) {
	...
	logs, sub, err := _Bacon.contract.FilterLogs(opts, "BaconBurned", tokenIdRule)
	if err != nil {
		return nil, err
	}
	return &BaconBaconBurnedIterator{contract: _Bacon.contract, event: "BaconBurned", logs: logs, sub: sub}, nil
}
...
func (_Bacon *BaconFilterer) WatchBaconBurned(opts *bind.WatchOpts, sink chan<- *BaconBaconBurned, tokenId []*big.Int) (event.Subscription, error) {
	...
	logs, sub, err := _Bacon.contract.WatchLogs(opts, "BaconBurned", tokenIdRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				if err := _Bacon.contract.UnpackLog(event, "BaconBurned", log); err != nil {
					return err
				}
				event.Raw = log
...
func (_Bacon *BaconFilterer) FilterBaconMinted(opts *bind.FilterOpts, tokenId []*big.Int, minter []common.Address, owner []common.Address) (*BaconBaconMintedIterator, error) {
	...
	logs, sub, err := _Bacon.contract.FilterLogs(opts, "BaconMinted", tokenIdRule, minterRule, ownerRule)
	if err != nil {
		return nil, err
	}
	return &BaconBaconMintedIterator{contract: _Bacon.contract, event: "BaconMinted", logs: logs, sub: sub}, nil
}
...
func (_Bacon *BaconFilterer) WatchBaconMinted(opts *bind.WatchOpts, sink chan<- *BaconBaconMinted, tokenId []*big.Int, minter []common.Address, owner []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Bacon.contract.WatchLogs(opts, "BaconMinted", tokenIdRule, minterRule, ownerRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				if err := _Bacon.contract.UnpackLog(event, "BaconMinted", log); err != nil {
					return err
				}
				event.Raw = log
...
func (_Bacon *BaconFilterer) FilterCopBurned(opts *bind.FilterOpts, tokenId []*big.Int) (*BaconCopBurnedIterator, error) {
	...
	logs, sub, err := _Bacon.contract.FilterLogs(opts, "CopBurned", tokenIdRule)
	if err != nil {
		return nil, err
	}
	return &BaconCopBurnedIterator{contract: _Bacon.contract, event: "CopBurned", logs: logs, sub: sub}, nil
}
...
func (_Bacon *BaconFilterer) WatchCopBurned(opts *bind.WatchOpts, sink chan<- *BaconCopBurned, tokenId []*big.Int) (event.Subscription, error) {
	...
	logs, sub, err := _Bacon.contract.WatchLogs(opts, "CopBurned", tokenIdRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				if err := _Bacon.contract.UnpackLog(event, "CopBurned", log); err != nil {
					return err
				}
				event.Raw = log
...
func (_Bacon *BaconFilterer) FilterCopMinted(opts *bind.FilterOpts, tokenId []*big.Int, minter []common.Address, owner []common.Address) (*BaconCopMintedIterator, error) {
	...
	logs, sub, err := _Bacon.contract.FilterLogs(opts, "CopMinted", tokenIdRule, minterRule, ownerRule)
	if err != nil {
		return nil, err
	}
	return &BaconCopMintedIterator{contract: _Bacon.contract, event: "CopMinted", logs: logs, sub: sub}, nil
}
...
func (_Bacon *BaconFilterer) WatchCopMinted(opts *bind.WatchOpts, sink chan<- *BaconCopMinted, tokenId []*big.Int, minter []common.Address, owner []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Bacon.contract.WatchLogs(opts, "CopMinted", tokenIdRule, minterRule, ownerRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				if err := _Bacon.contract.UnpackLog(event, "CopMinted", log); err != nil {
					return err
				}
				event.Raw = log
