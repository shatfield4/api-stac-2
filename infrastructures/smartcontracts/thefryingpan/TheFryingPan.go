...
func (_Thefryingpan *ThefryingpanFilterer) FilterBaconClaimed(opts *bind.FilterOpts, tokenId []*big.Int) (*ThefryingpanBaconClaimedIterator, error) {
	...
	logs, sub, err := _Thefryingpan.contract.FilterLogs(opts, "BaconClaimed", tokenIdRule)
	if err != nil {
		return nil, err
	}
	return &ThefryingpanBaconClaimedIterator{contract: _Thefryingpan.contract, event: "BaconClaimed", logs: logs, sub: sub}, nil
}
...
func (_Thefryingpan *ThefryingpanFilterer) WatchBaconClaimed(opts *bind.WatchOpts, sink chan<- *ThefryingpanBaconClaimed, tokenId []*big.Int) (event.Subscription, error) {
	...
	logs, sub, err := _Thefryingpan.contract.WatchLogs(opts, "BaconClaimed", tokenIdRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				if err := _Thefryingpan.contract.UnpackLog(event, "BaconClaimed", log); err != nil {
					return err
				}
				event.Raw = log
...
func (_Thefryingpan *ThefryingpanFilterer) FilterBaconCopClaimed(opts *bind.FilterOpts, tokenId []*big.Int) (*ThefryingpanBaconCopClaimedIterator, error) {
	...
	logs, sub, err := _Thefryingpan.contract.FilterLogs(opts, "BaconCopClaimed", tokenIdRule)
	if err != nil {
		return nil, err
	}
	return &ThefryingpanBaconCopClaimedIterator{contract: _Thefryingpan.contract, event: "BaconCopClaimed", logs: logs, sub: sub}, nil
}
...
func (_Thefryingpan *ThefryingpanFilterer) WatchBaconCopClaimed(opts *bind.WatchOpts, sink chan<- *ThefryingpanBaconCopClaimed, tokenId []*big.Int) (event.Subscription, error) {
	...
	logs, sub, err := _Thefryingpan.contract.WatchLogs(opts, "BaconCopClaimed", tokenIdRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				if err := _Thefryingpan.contract.UnpackLog(event, "BaconCopClaimed", log); err != nil {
					return err
				}
				event.Raw = log
